...
processEPUB(args.filepath,args.pages,args.suffix,args.outpath,args.name,args.nonav,args.noncx,args.breakmode,pageMode,tuple(args.tocpages),args.page_map,args.suggest,args.autopage)