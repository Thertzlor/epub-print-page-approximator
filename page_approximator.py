...
processEPUB(args.filepath,args.pages,args.suffix,args.outpath,args.name,args.nonav,args.noncx,args.breakmode,pageMode,tuple(int(x) if x.isnumeric() else x for x in args.tocpages),args.page_map,args.suggest,args.autopage,romans)